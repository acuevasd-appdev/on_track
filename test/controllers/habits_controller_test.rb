...
class HabitsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create habit" do
    assert_difference('Habit.count') do
      post habits_url, params: { habit: { current_progress: @habit.current_progress, description: @habit.description, frequency: @habit.frequency, goal_frequency: @habit.goal_frequency, habit_type: @habit.habit_type, owner_id: @habit.owner_id, private: @habit.private, steps_count: @habit.steps_count, title: @habit.title, top_streak: @habit.top_streak } }
    end
  ...
  test "should update habit" do
    patch habit_url(@habit), params: { habit: { current_progress: @habit.current_progress, description: @habit.description, frequency: @habit.frequency, goal_frequency: @habit.goal_frequency, habit_type: @habit.habit_type, owner_id: @habit.owner_id, private: @habit.private, steps_count: @habit.steps_count, title: @habit.title, top_streak: @habit.top_streak } }
